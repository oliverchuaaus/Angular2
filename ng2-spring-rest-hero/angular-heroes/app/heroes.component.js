...
var HeroesComponent = (function () {
    ...
    HeroesComponent.prototype.getHeroes = function () {
        var _this = this;
        this.heroService.getHeroes().then(function (heroes) { return _this.heroList = heroes; });
    };
    ...
    HeroesComponent.prototype.delete = function (hero) {
        ...
        this.heroService
            .delete(hero.id)
            .then(function () {
            _this.heroList = _this.heroList.filter(function (h) { return h !== hero; });
